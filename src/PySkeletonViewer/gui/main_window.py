...
from PySkeletonViewer.gui.main import Ui_MainWindow
from PySkeletonViewer.modules.projection import ProjectionCanvas
from PySkeletonViewer.client import HOST
...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self, app):
        ...
        self.setupUi(self)
        self.app = app
        self.setWindowIcon(QIcon(os.path.abspath(os.path.join(self.app.path, "PySkeletonViewer", "images", "icon.png"))))
        self.setWindowTitle(u"Skeleton Viewer")
        self.fill_interface()
        self.connect()
